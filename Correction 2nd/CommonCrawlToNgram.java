 ...
 * @since 3.2
 */
class CommonCrawlToNgram extends DuplicatedCodeKs implements AutoCloseable {
  ...
  private final Map<Integer, org.languagetool.dev.bigdata.CommonCrawlToNgram.LuceneLiveIndex> indexes = new HashMap<>();
  ...
  CommonCrawlToNgram(Language language, File input, File indexTopDir, File evalFile) throws IOException {
    ...
    indexes.put(1, new org.languagetool.dev.bigdata.CommonCrawlToNgram.LuceneLiveIndex(new File(indexTopDir, "1grams")));
    indexes.put(2, new org.languagetool.dev.bigdata.CommonCrawlToNgram.LuceneLiveIndex(new File(indexTopDir, "2grams")));
    indexes.put(3, new org.languagetool.dev.bigdata.CommonCrawlToNgram.LuceneLiveIndex(new File(indexTopDir, "3grams")));
  }

  @Override
  public void close() throws IOException {
    for (org.languagetool.dev.bigdata.CommonCrawlToNgram.LuceneLiveIndex index : indexes.values()) {
      index.close();
    }
  }
  ...
  private void writeToLucene(int ngramSize, Map<String, Long> ngramToCount) throws IOException {
    ...
    org.languagetool.dev.bigdata.CommonCrawlToNgram.LuceneLiveIndex index = indexes.get(ngramSize);
...
//  *------------------------------------------------------------------------------*
  ...
  public static void main(String[] args) throws IOException {
    if (args.length != 4) {
      System.out.println("Usage: " + org.languagetool.dev.bigdata.CommonCrawlToNgram.class + " <langCode> <input.xz> <ngramIndexDir> <simpleEvalFile>");
    ...
    try (org.languagetool.dev.bigdata.CommonCrawlToNgram prg = new org.languagetool.dev.bigdata.CommonCrawlToNgram(language, input, outputDir, evalFile)) {
      prg.indexInputFile();
    }
  }
